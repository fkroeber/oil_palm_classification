...
from nn_utils import EarlyStopping, RotationTransform
...
class Trainer:
    ...
    def __init__(self, **kwargs):
        ...
        loss: loss function used for training - options are "CE", "BCE"
    ...
    def train_model(self):
        ...
        # check if model is inception - requires certain adjustment during training
